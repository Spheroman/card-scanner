...
**Description:**  
Uploads an image file, uses YOLO for card detection and segmentation, performs perspective correction, and returns identification results using ORB+VLAD matching.
...
**Description:**  
Resizes the input image to standard card dimensions and performs VLAD matching directly.
